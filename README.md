...
Predicts the price of a car based on features such as brand, mileage, engine size, and year.  
[Car Price App](https://car-price-predictor-kunskapskontroll.streamlit.app/)
...
Some models are trained on subsets of data to reduce training time.
